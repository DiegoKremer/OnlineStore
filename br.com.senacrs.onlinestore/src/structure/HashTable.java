...
public class HashTable {
	...
	public void insert(Book value) {
		...
		if (table[firstHash] == null
			...
			/* If position not null will try the second function. */
				...
				|| table[secondHash].getKey() != value.getISBN()) {
			 ...
			 */
				...
				|| table[thirdHash].getKey() != value.getISBN()) {
	...
	private int hashFunctionThree(long value) {
		...
		try {
			hash = integerValue % hashFunctionTwo(value);
		} catch (ArithmeticException e) {
			hash = integerValue % (capacity() / 5) % 3;
		}
		return hash;
	}
